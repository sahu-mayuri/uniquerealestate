    ...
    return (
      <div id="card-container" className="w-full bg-white">
          <div id="image-container" className="w-full h-[13.5rem] md:h-[18rem] overflow-hidden ">
              <img className=" w-full h-full object-cover hover:scale-110  hover:text-color-orange hover:cursor-pointer " src="https://imgs.search.brave.com/Gj8wm0N7lLF3OI34pIiTMxdARdkBJ1xTDQQHmDtuDmU/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9yZWFs/ZXN0YXRlZXhwb3N1/cmVzLmNvbS93cC1j/b250ZW50L3VwbG9h/ZHMvMjAyMy8xMi8z/MjQtRS5GaWVsZHN0/b25lLTE3LXNjYWxl/ZC5qcGc" alt="" />
          </div>
          <div id="dets-container" className="w-full p-4">
              <div id="icons" className="p-2 flex gap-4 mt-2">
                  ...
                  <div id="location" className="flex items-center">
                      <div className="icon">
                          <svg className="text-color-orange text-[0.75rem] me-2" stroke="currentColor" fill="currentColor" strokeWdth="0" viewBox="0 0 640 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M497.941 225.941L286.059 14.059A48 48 0 0 0 252.118 0H48C21.49 0 0 21.49 0 48v204.118a48 48 0 0 0 14.059 33.941l211.882 211.882c18.744 18.745 49.136 18.746 67.882 0l204.118-204.118c18.745-18.745 18.745-49.137 0-67.882zM112 160c-26.51 0-48-21.49-48-48s21.49-48 48-48 48 21.49 48 48-21.49 48-48 48zm513.941 133.823L421.823 497.941c-18.745 18.745-49.137 18.745-67.882 0l-.36-.36L527.64 323.522c16.999-16.999 26.36-39.6 26.36-63.64s-9.362-46.641-26.36-63.64L331.397 0h48.721a48 48 0 0 1 33.941 14.059l211.882 211.882c18.745 18.745 18.745 49.137 0 67.882z"></path></svg>
                      </div>
                      <div id="text">
                          <h1 className="font-nunito_SemiBold text-gray-500 text-[75%] md:text-[85%] lg:text-[85%] hover:text-color-orange hover:cursor-pointer">REAL ESTATE</h1>
                      </div>
                  </div>
              </div>  
              <div id="dets" className="w-full">
                  <h1 className="font-popins p-2 text-[100%] font-semibold md:text-[115%] lg:text-[115%] lg:font-bold hover:text-color-orange hover:cursor-pointer">Renovating A Living Room? Experts Share Their Secrets</h1>
              </div>
              {/* HORIZONTAL LINE!! */}
              ...
              <div id="icons" className="p-2 flex justify-between gap-4">
                  <div id="admin" className="flex gap-2">
                      ...
                      <div id="text">
                          <h1 className="font-nunito_SemiBold text-gray-500 text-[75%] md:text-[85%] lg:text-[85%]">July 11, 2024</h1>
                      </div>
                  </div>
