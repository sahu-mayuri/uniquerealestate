    ...
    return (
      <div id="card-container" className="w-full bg-white">
          <div id="image-container" className="w-full h-[13.5rem] md:h-[18rem] overflow-hidden ">
              <img className=" w-full h-full object-cover hover:scale-110 transition duration-500 ease-in-out " src="https://imgs.search.brave.com/Gj8wm0N7lLF3OI34pIiTMxdARdkBJ1xTDQQHmDtuDmU/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9yZWFs/ZXN0YXRlZXhwb3N1/cmVzLmNvbS93cC1j/b250ZW50L3VwbG9h/ZHMvMjAyMy8xMi8z/MjQtRS5GaWVsZHN0/b25lLTE3LXNjYWxl/ZC5qcGc" alt="" />
          </div>
          <div id="dets-container" className="w-full p-4">
              ...
              <div id="dets" className="w-full">
                  <h1 className="font-popins p-2 text-[100%] font-semibold md:text-[115%] lg:text-[115%] lg:font-bold">Renovating A Living Room? Experts Share Their Secrets</h1>
              </div>
              {/* HORIZONTAL LINE!! */}
