...
const Card = () => {
  return (
    <div id="card-container" className="w-[19.5rem] lg:w-[21rem] bg-white ">
        ...
        <div id="dets-container" className="w-full p-4 lg:p-2">
            ...
            <div id="icons" className="p-2 flex gap-4 mt-2">
                ...
                <div id="admin" className="flex items-center ">
                    ...
                    <div id="text">
                        <h1 className=" text-[75%] text-gray-400   md:text-[85%]  lg:text-[85%]">By:Admin</h1>
                    </div>
                </div>
                ...
                <div id="location" className="flex items-center ">
                    ...
                    <div id="text">
                        <h1 className=" text-[75%] text-gray-400   md:text-[85%]  lg:text-[85%]">REAL ESTATE</h1>
                    </div>
                </div>
            ...
            <div id="dets" className="w-full ">
                ...
                <h1 className="font-poppins p-2 text-[100%] font-semibold md:text-[115%] lg:text-[115%] lg:font-bold">Revnovating A Living Room?  Exprets Share Their Secrets</h1>
            </div>
            {/* HORIZONTAL LINE!! */}
            ...
            <div id="icons" className="p-2 flex justify-between gap-4 ">
                <div id="admin" className="flex gap-2">
                    ...
                    <div id="text">
                        <h1 className=" text-[75%] text-gray-400 font-poppins   md:text-[85%] lg:text-[85%]">July 11, 2024</h1>
                    </div>
                </div>
                <div id="location" className="flex">
                    
                    <div id="text">
                        <h1 className=" text-[75%]  md:text-[85%] lg:text-[85%] font-medium text-color-orange">READ MORE</h1>
                    </div>
                </div>
            </div>
