    ...
    <div>
      <div className='w-full h-[21rem] mb-5 mt-20 bg-fixed bg-center bg-cover' style={{ backgroundImage: 'url("/images/19.jpg")' }}>
        <div id="videoIcon" className='w-full h-full flex justify-center items-center'>
          <div id="icon" className='relative flex justify-center items-center w-14 h-14 bg-white rounded-full '>
            <div id="animation" className='animate-ping rounded-full size-14 absolute -left-0 -top-0  bg-white'></div>
