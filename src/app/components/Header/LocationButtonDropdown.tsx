...
export default function LocationButtonDropdown() {
  const locationList = [{ id: '01', name: 'Location' },
  { id: '02', name: 'chicago' },
  { id: '03', name: 'London' },
  { id: '04', name: 'Los Angeles' },
  { id: '05', name: 'New York' }]
  const [selectedLocation, setSelectedLocation] = useState(locationList[0]);

  const handleLocationSelect = (location: SetStateAction<{ id: string; name: string; }>) => {
    ...
    <Menu as="div" className="relative inline-block text-left w-full group">
      <div className='flex flex-row'>
        ...
        <div className='flex flex-row items-center'>
          <svg className='size-4 mx-2 text-color-orange' stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 480 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
