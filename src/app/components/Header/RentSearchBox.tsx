  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-5 bg-[#F2F6F7] animate-pulse '>
                    ...
                    <div className='col-span-1 md:col-span-2 lg:col-span-3 content-center mb-4 flex justify-center'>
                        <button className='bg-color-orange text-nowrap px-6 lg:px-10 py-4 lg:py-2 lg:h-16 font-poppins md:text-lg uppercase text-white hover:text-black hover:bg-white hover:outline hover:outline-1'>Search Inventory</button>
                    </div>
                </div>
  )
}
