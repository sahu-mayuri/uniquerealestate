export default function ServicesCard (props){
    return(
        <>
            <div className="ServicesCard bg-white w-full h-[23.4rem] pt-[2.5rem] pb-[2.188rem] pr-[1.875rem] pl-[1.875rem] shadow-box-shadow-4 ">
                <div className="w-full h-full">
                    <div className="w-full h-[8.75rem] pb-[1.25rem] flex justify-center"><img className="w-[11.563rem]" src={props.img}></img></div>
                    <div className="w-full ">
                        <h3 className="mb-[1.938rem] flex justify-center"><a href="" className="text-lg font-bold">{props.title}</a></h3>
                        <p className="lg:text-xs text-center font-extralight">over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
                        <div className="flex justify-center">
                            <a href="" className="mt-[1.563rem] ">Find A Home</a>
                        </div>
