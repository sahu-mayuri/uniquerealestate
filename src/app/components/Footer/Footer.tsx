      ...
      <div className='bg-[#171B2A] p-6 pt-10 text-white'>
        <div id="footer-container" className='grid grid-cols-1 w-full  md:grid-cols-2 lg:flex lg:flex-wrap '>
          <div id='c1' className='w-full lg:w-[23%] h-full mb-6' >
            <div>
              <div id="footer_logo" className="mb-2">
              ...
              <div id="dets" className="">
                ...
                <p className=" mb-4 flex items-center justify-start md:justify-start text-[0.8rem] md:text-[1rem] lg:text-[1rem] text-white ">
                  {/* THIS IS LOCATION SVG */}
                  <svg
                    className=" text-[0.9rem] md:text-[1rem] lg:text-[1rem] mr-3 text-white"
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
                    viewBox="0 0 384 512"
              ...
              <p className="flex items-center justify-start md:justify-start">
                <div id="all_logos" className="flex gap-4  text-white">
                  <svg
                    className="text-[0.9rem] ml-2"
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
                    viewBox="0 0 320 512"
          ...
          <div id='c2' className='w-full lg:w-[18%] h-full ' >
            <h5 className=" font-bold mb-[1.5rem] text-[1.4rem]  text-start text-white">
              Contact
            </h5>
            ...
            <ul className="mb-0 list-none  text-start cursor-pointer">
              ...
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
                <a className=" dark:text-neutral-200">Blogs</a>
              </li>
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
                <a className=" dark:text-neutral-200">All Products</a>
              </li>
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
                <a className=" dark:text-neutral-200">Location Map</a>
              </li>
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
          ...
          <div id='c3' className='w-full lg:w-[18%] h-full ' >
            <h5 className=" font-bold mb-[1.5rem] text-[1.4rem]  text-start text-white">
              Services
            </h5>
            ...
            <ul className="mb-0 list-none  text-start cursor-pointer">
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
                <a className=" dark:text-neutral-200">Order tracking</a>
              </li>
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
                <a className=" dark:text-neutral-200">Wish List</a>
              </li>
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
                <a className=" dark:text-neutral-200">Login</a>
              </li>
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
                <a className=" dark:text-neutral-200">My account</a>
              </li>
              <li className="mb-[0.9rem] text-[0.9rem] md:text-[1rem] lg:text-[1rem]">
          ...
          <div id='c4' className='w-full lg:w-[18%] h-full ' >
          ...
          <div id='c5' className='w-full lg:w-[23%] h-full ' >
            <h5 className="text-[1.5rem] font-bold mb-[1.3rem]  text-start text-white">
              Newsletter
            </h5>
            ...
            <ul className="mb-0 list-none  text-start">
              ...
              <li>
                <div id="input" className="flex  md:mt-[1.5rem] ">
                  ...
                  <div
                    id="logo-box"
                    className="w-[18%] h-[4.05rem] bg-color-orange flex justify-center items-center"
                  >
                    <svg
                      className=""
                      stroke="currentColor"
              ...
              <li>
                <img id="lll" className=" bg-green-500" src="/images/payment.png" alt="payment" />
              </li>
            </ul>
          </div>
        </div>
