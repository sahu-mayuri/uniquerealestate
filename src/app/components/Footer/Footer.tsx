        ...
        <div id="footer-container" className='grid grid-cols-1 w-full  md:grid-cols-2 custom_screen:flex custom_screen:flex-wrap '>
            ...
            <div>
                  ...
                  <div id="dets" className="">
                    ...
                    <p className=" mb-4 flex items-center justify-start md:justify-start text-[0.8rem] md:text-[1rem] custom_screen:text-[1rem] text-white ">
            ...
            <h5 className="mb-[1.5rem] text-[1.4rem] font-bold  font-poppinsExtraBold  text-start text-white">
                    Customer Care
                  </h5>
            ...
            <h5 className="text-[1.5rem] font-bold mb-[1.3rem] font-poppinsExtraBold text-start text-white">
                    Newsletter
                  </h5>

                  <ul className="mb-0 list-none  text-start">
                    <li>
                      <p className="text-[0.9rem] mb-6  text-start text-white md:pr-5">
                    ...
                    <li className="text-[1.2rem] mb-6">
                      <a className=" font-poppinsExtraBold">We accept</a>
                    </li>
                    <li>
