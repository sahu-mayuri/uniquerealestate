...
const Card = (props: any) => {
    ...
    return (
        ...
        >
            ...
            {isHovered && (
                <div className="underline-animation bg-color-orange h-[2px] lg:h-[4px] w-0 absolute bottom-0 left-0"></div>
            )}
        </div>
    );
};
